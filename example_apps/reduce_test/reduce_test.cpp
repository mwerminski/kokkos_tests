...
int main(int argc, char* argv[]) {
    ...
    Kokkos::parallel_reduce("reduce_add", cuda_range_policy(0, N), AddFunctor(), final_value_1);
    Kokkos::parallel_reduce("reduce_add", openmp_range_policy(0, N), AddFunctor(), final_value_2);
